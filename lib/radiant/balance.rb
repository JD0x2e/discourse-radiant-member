...
module Radiant
  ...
  @radiant_uri_bsc = "https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/5Ly2du4z5V6w6QDipo3HQ2u2ixRiJ22GZFyu4fr1G9a4"
  ...
  @radiant_uri_base = "https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/eRZDs5XjgGo5qMFQbZAYduYcGoCDBCBCEoj3afU9Fo8"
  ...
  @radiant_uri_dlp_price_bsc = "https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/4m8J28eSJRLqHRHYVGoDtsS5gNPfcGjTLZ86fusddrk"
  ...
  @radiant_uri_dlp_price_base = "https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/Ae41HtcRSU6EhpQcmUFSxkEEXgC1PhDee4t82i2RfbCR"
  ...
  @rdnt_token_address_base = '0xd722E55C1d9D9fA0021A5215Cbb904b92B3dC5d4'
  @dlp_token_address_base = '0x8A76639FE8e390Ed16eA88f87BEB46d6A5328254'
  ...
  @mfd_base = '0xD87F8a52a91680c993ece968B281bf92505A3741'
  ...
  def self.fetch_and_cache_rdnt_amount(user, cache_key_total, cache_key_address, current_address, force_refresh: false)
    if force_refresh || Discourse.cache.read(cache_key_total).nil? || current_address != Discourse.cache.read(cache_key_address)
        ...
        loose_rdnt_in_wallet_base = get_loose_rdnt_in_wallet_amount(user.username, SiteSetting.radiant_quicknode_base, @rdnt_token_address_base)
        ...
        fully_vested_rdnt_base = get_fully_vested_rdnt_amount(user.username, SiteSetting.radiant_quicknode_base, @mfd_base)
        ...
        loose_rdnt_in_wallet_base = loose_rdnt_in_wallet_base || 0
        ...
        fully_vested_rdnt_base = fully_vested_rdnt_base || 0
        ...
        puts "rdnt_amount_from_locked_and_loose_base: #{rdnt_amount_from_locked_and_loose_base}"
        ...
        puts "loose_rdnt_in_wallet_base: #{loose_rdnt_in_wallet_base}"
        ...
        puts "fully_vested_rdnt_base: #{fully_vested_rdnt_base}"

        # Sum amounts from all chains and the wallet
        total_rdnt_amount = rdnt_amount_from_locked_and_loose_arbitrum.to_f + rdnt_amount_from_locked_and_loose_bsc.to_f + rdnt_amount_from_locked_and_loose_ethereum.to_f + rdnt_amount_from_locked_and_loose_base.to_f + loose_rdnt_in_wallet_arbitrum.to_f + loose_rdnt_in_wallet_bsc.to_f + loose_rdnt_in_wallet_ethereum.to_f + loose_rdnt_in_wallet_base.to_f + fully_vested_rdnt_arbitrum.to_f + fully_vested_rdnt_bsc.to_f + fully_vested_rdnt_ethereum.to_f + fully_vested_rdnt_base.to_f
